...
<head>
    ...
    <title> Recruiter Login | @isset($SiteOption)
        {{ $SiteOption[0]->value }}
    @endisset </title>
            ...
            <div class="col-12 col-md-4 col-lg-4 h-50 ">
              <div class="card shadow">
                ...
                @error('email')
                  ...
                  <h4 class="card-title mt-1 text-center">Recruiter Login</h4>
                  <form method="POST" action="{{ route('recruiter.login') }}">
                    ...
                    @if (Route::has('recruiter.password.request'))
                    ...
                    <p class="text-center">Don't Have an account?
                        <a href="{{ route('recruiter.register') }}" class="btn btn-block btn-info">
