...
@section('content')
    ...
    <div class="card shadow m-4">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('recruiter.job.update',$data->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        <th>Vacancy</th>
                        <td><input required name="vacancy" type="number" value="{{ $data->vacancy }}" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>Tags</th>
