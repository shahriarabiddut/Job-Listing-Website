...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="{{ url('recruiter/email') }}" class="float-right btn btn-success btn-sm"> <i class="fa fa-arrow-left"></i> View All </a> </h6>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                @endif
            <form method="POST" action="{{ route('recruiter.email.store') }}" enctype="multipart/form-data">
                @csrf
