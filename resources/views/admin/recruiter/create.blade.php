...
@section('title', 'Create New Recruiter')
@section('content')


    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Create New Recruiter</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Add New Recruiter
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                @endforeach
                @endif
            <form method="POST" action="{{ route('admin.recruiter.store') }}" enctype="multipart/form-data">
                @csrf
