                    ...
                    @if ($data!=null)
                        ...
                        <div class="job-item p-4 mb-4">
                            <div class="row g-4">
                                ...
                                <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                    <div class="d-flex mb-3">
                                        <a class="btn btn-info mx-1" href="{{ route('staff.job.edit',$jobs->id) }}">Edit</a>
                                        <a class="btn btn-primary mx-1" href="">View</a>
                                    </div>
                                    <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>Date Line:{{ $jobs->deadline }}</small>
                                </div>
                            </div>
                        </div> 
                        @endforeach
